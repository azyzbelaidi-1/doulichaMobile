...
public class evenement {
    ...
    private String dateDebut_event;
    ...
    public evenement(int ID_event, String nom_event, String description_event, String lieu_event, String type_event, String dateDebut_event, String dateFin_event, int capacite_event,String image_event, double prix_event) {
    ...
    public evenement(String nom_event, String description_event, String lieu_event, String type_event, String dateDebut_event, String dateFin_event, int capacite_event, String image_event, double prix_event) {
        this.nom_event = nom_event;
        this.description_event = description_event;
        this.lieu_event = lieu_event;
        this.type_event = type_event;
    ...
    public String getDateDebut_event() {
        return dateDebut_event;
    }

    public void setDateDebut_event(String dateDebut_event) {
        this.dateDebut_event = dateDebut_event;
    }
