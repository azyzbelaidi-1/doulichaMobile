...
public class DiscussionsForm extends Form {
...
// Bouton Ajouter
        ...
        ajouterButton.addActionListener(e -> {
            ...
            if (i >= 0.7) {
                ...
                DiscussionsForm h = new DiscussionsForm();
                h.show();
            }
        });
        nouvelleDiscussionContainer.getStyle().setMargin(50, 80, 30, 30);
        nouvelleDiscussionContainer.add(ajouterButton);
        add(nouvelleDiscussionContainer);

        TextField searchField = new TextField();
        searchField.getStyle().setMargin(30, 50, 20, 20);
            ...
            try {
                ...
                if (data != null) {
                    ...
                    if (discussions != null) {
                        ...
                        container.getStyle().setMargin(30, 0, 20, 20);
                                    ...
                                    for (Map<String, Object> discussion : (ArrayList<Map<String, Object>>) discussions.get("discussions")) {
                                        if ((((String) discussion.get("titreDiscussion")).toLowerCase().contains(text.toLowerCase())) || (((String) discussion.get("contenuDiscussion")).toLowerCase().contains(text.toLowerCase()))) {
                                            ...
                                            visitButton.addActionListener((evt) -> {
                                                ...
                                                try {
                                                    showForm = new DetailDiscussionForm(id, false);
                                                } catch (IOException ex) {
                                                    ex.printStackTrace();
                                                }
                                                showForm.show();
                                            ...
                                            editButton.addActionListener((evt) -> {
                                                ...
                                                DetailDiscussionForm showForm = null;
                                                try {
                                                    showForm = new DetailDiscussionForm(id, true);
                                                } catch (IOException ex) {
                                                    ex.printStackTrace();
                                                }
                                                showForm.show();
                                            ...
                                            title.getStyle().setMargin(30, 50, 20, 20);
...
// Formater la date
                                            ...
                                            if ((String) discussion.get("imageDiscussion") != null && (String) discussion.get("imageDiscussion") != "") {
                                                ...
                                                imageContainer.getStyle().setMargin(20, 40, 0, 0);
