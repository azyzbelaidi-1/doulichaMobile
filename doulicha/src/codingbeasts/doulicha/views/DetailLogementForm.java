...
public class DetailLogementForm extends Form {
    ...
    public DetailLogementForm(int id){
...
detailsContainer.add(containerMap);
            ...
            reserverButton.addActionListener(e1 -> new ReserverLogementForm(idd).show());
            annulerButton.addActionListener(e1 -> new afficherLogementsForm().show());
