...
// Ajouter les champs au formulaire
    ...
    dateArriveeField.setText(selectedDateStr);
        ...
        //DATE DE DEPART
        String datedepartReservationString=(String) reservation.get("datearriveeReservation");
SimpleDateFormat dateFormat5 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
Date datedepart = null;
                try {
                    datearrivee = dateFormat5.parse(datearriveeReservationString);
                } catch (ParseException ex) {
                    ex.printStackTrace();
                }
