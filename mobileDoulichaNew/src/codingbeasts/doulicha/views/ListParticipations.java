...
public class ListParticipations extends SideMenu{
 ...
 for (participation_evenement pe : list) {
   ...
   String qrCodeContent = "INFORMATIONS DE VOTRE PARTICIPATION : \n "
                      + " ID de la participation: " + pe.getID_participation() + "\n"
          
           + " Numéro de téléphone: " + pe.getNum_tel()+ "\n"
           + "Nombre de tickets " + String.valueOf(Math.round(pe.getNombre_participation()));
...
Label qrCodeLabel = new Label(qrCodeImage);
    ...
    if (dig.show("Suppression", "Vous voulez supprimer cette participation ?", "Oui", "Annuler")){
