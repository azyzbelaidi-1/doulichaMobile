...
public class DetailDiscussionForm extends Form {
    ...
    public DetailDiscussionForm(int idDiscussion, Boolean editMode, Resources res) throws IOException {
...
// Formater la date
                            ...
                            if (editMode == true) {
                                ...
                                modifier.addActionListener(e4 -> {
                                    ...
                                    if (j >= 0.7) {
                                        ...
                                        request2.addArgumentNoEncoding("titreDiscussion", title.getText());
                                        request2.addArgumentNoEncoding("contenuDiscussion", contenu);

                                        request2.addArgumentNoEncoding("idUser", idUserConnecteString);
                                        ...
                                        try {
                                            DiscussionsForm sh1 = new DiscussionsForm(res);
                                            sh1.revalidate();
                                            sh1.show();
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                        ...
                        ajouterButton.addActionListener(e1 -> {
                            ...
                            if (tox >= 0.7) {
                                ...
                                request1.addArgumentNoEncoding("contenuReponse", contenu);
                                String id = String.valueOf(idDiscussion);
                                request1.addArgumentNoEncoding("idDiscussion", id);
                                                                        request1.addArgumentNoEncoding("idUser", idUserConnecteString);
                                ...
                                try {
                                    DetailDiscussionForm sh = new DetailDiscussionForm(idDiscussion, false, res);
                                    sh.show();
                                                                        sh.revalidate();
...
// Formater la date
                                ...
                                editButton.addActionListener((evt) -> {
                                    ...
                                    enregistrerButton.addActionListener((evt1) -> {
                                        ConnectionRequest request1 = new ConnectionRequest();
                                        request1.addArgumentNoEncoding("contenuReponse", repcontent.getText());
                                                                                request1.addArgumentNoEncoding("idUser", idUserConnecteString);
