...
public class Utilisateur {
    ...
    public Utilisateur(int ID_user, String nom_user, String mdp_user, String role_user, String status_user) {
...
//
//    public Utilisateur(int userId, String userName, String userPassword, String userRole, String userStatus) {
...
//        this.mdp_user = (mdp_user);
//    }
    public Utilisateur(String email_user,String nom_user, String prenom_user,  String mdp_user) {
         this.email_user = email_user;
        this.nom_user = nom_user;
        this.prenom_user = prenom_user;
