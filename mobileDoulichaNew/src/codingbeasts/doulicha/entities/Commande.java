...
public class Commande {
    ...
    public Commande(int ID_user,String date_commande, int etat_commande) {
    ...
    public Commande(int ID_user, int etat_commande) {
        this.ID_user = ID_user;
        this.etat_commande = etat_commande;
    ...
    public Commande(int ID_commande,int ID_user,String date_commande, int etat_commande) {
