...
public class reclamation {
    ...
    public reclamation(int ID_reclamation, int ID_user, String contenu_reclamation, String date_reclamation, int etat_reclamation) {
    ...
    public reclamation(int ID_user, String contenu_reclamation, String date_reclamation, int etat_reclamation) {
        this.ID_user = ID_user;
        this.contenu_reclamation = contenu_reclamation;
        this.date_reclamation = date_reclamation;
        this.etat_reclamation = etat_reclamation;
