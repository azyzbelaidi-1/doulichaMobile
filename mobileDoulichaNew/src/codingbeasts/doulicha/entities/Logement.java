...
public class Logement {
    ...
    public Logement(int ID_logement, String nom_logement, String description_logement, String adresse_logement, double prixNuitee_logement, int capacite_logement,String type_logement, String image_logement) {
     ...
     public Logement( String nom_logement, String description_logement, String adresse_logement, double prixNuitee_logement, int capacite_logement,String type_logement, String image_logement) {
        this.nom_logement = nom_logement;
        this.description_logement = description_logement;
        this.adresse_logement = adresse_logement;
        this.prixNuitee_logement = prixNuitee_logement;
   ...
   public static String getNomLogementById(int id, List<Logement> logements) {
    for (Logement logement : logements) {
        if (logement.getID_logement() == id) {
            return logement.getNom_logement();
        }
    }
    return null; // retourne null si l'id ne correspond à aucun logement
}
