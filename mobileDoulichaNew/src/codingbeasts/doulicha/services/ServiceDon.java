...
import codingbeasts.doulicha.views.Paiement;
import static codingbeasts.doulicha.services.ServiceProjet.resultOk;
...
public class ServiceDon {
 ...
 Utilisateur UserConnecte = ServicesUtilisateur.getInstance().getUtilisateurConnecte();
    ...
    String url = Statics.BASE_URL + "/AjoutDonmobile/" + idProjet + "?valeurDon=" + valeurDon+"&id="+idUserConnecte;

    ConnectionRequest req = new ConnectionRequest(url);
    req.setPost(true);
    
                req.addArgument("id", String.valueOf(idUserConnecte));
 ...
 public ArrayList<Don>affichageDons() {
        ArrayList<Don> result = new ArrayList<>();
         Utilisateur UserConnecte = ServicesUtilisateur.getInstance().getUtilisateurConnecte();
                int idUserConnecte=UserConnecte.getID_user();
        String url = Statics.BASE_URL+"/ListDonmobile?id="+idUserConnecte;
        req.setUrl(url);
...
re.setDateDon(dateString2);
 ...
 public ArrayList<Don>affichageDonsPaye() {
        ...
        Utilisateur UserConnecte = ServicesUtilisateur.getInstance().getUtilisateurConnecte();
                int idUserConnecte=UserConnecte.getID_user();
        String url = Statics.BASE_URL+"/ListDonPayemobile?id="+idUserConnecte;
        req.setUrl(url);
